...
namespace Tyuiu.RotachAO.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Ротач.А.О. | ИИПб-24-1"; 
            Console.WriteLine("***************************************************************************");
            ...
            for (int i = 0; i < arrayNums1.Length; i++) Console.Write(arrayNums1[i] + ", ");
            Console.WriteLine();
